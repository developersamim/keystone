...
namespace IdentityServer.IdentityServerConfig.KeyVault;
...
public sealed class AzureKeyVaultSigningCredentialsStore : ISigningCredentialStore, IValidationKeysStore
{
    ...
    public AzureKeyVaultSigningCredentialsStore(KeyVaultClient keyVaultClient, KeyVaultConfig keyVaultConfig, IMemoryCache cache)
    {
